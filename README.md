...
- **Go:**
  ...
  - [golint](https://github.com/golang/lint) (deprecated, use `staticcheck` — golint has been [frozen and deprecated](https://github.com/golang/go/issues/38968) by its authors)
