...
- **`[linter]_files`**: Specify comma separated files to be linted. Example: `eslint_files: "Inpu.tsx, Home.tsx"` if ESLint checks should fail even if there are no errors and only warnings. Default: `"."`
