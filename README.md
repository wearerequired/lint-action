...
`[linter]` can be one of `black`, `oitnb`, `eslint`, `flake8`, `gofmt`, `golint`, `mypy`, `php_codesniffer`, `prettier`, `rubocop`, `stylelint`, `swift_format_official`, `swift_format_lockwood`, `swiftlint` and `xo`:
