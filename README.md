...
- **`[linter]_command_prefix`:** Command prefix to be run before the linter command. Example: `eslint_command_prefix: cat changed_files.txt |` to pipe in a list of changed files. Default: none.
